...
SECRET_KEY = 'django-insecure-your-secret-key-here-for-assessment'
...
# Database
# Using SQLite as requested for simplicity
DATABASES = {
    "default": {
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,
    # This will hook up our custom error handler later
